            ...
            <div class="row px-xl-5">
                ...
                <div class="col-lg-12 col-md-8">
                    <div class="row pb-3">
                        ...
                        <%
                            List<Product> searchResultsCategory = (List<Product>) session.getAttribute("searchResultsCategory");
                        %>

                        <% if (searchResultsCategory != null && !searchResultsCategory.isEmpty()) {%>

                        <% int totalPages = (int) Math.ceil((double) searchResultsCategory.size() / PAGE_SIZE); %>
                        <% int startIndex = (currentPage - 1) * PAGE_SIZE; %>
                        <% int endIndex = Math.min(startIndex + PAGE_SIZE, searchResultsCategory.size()); %>


                        <% for (int i = startIndex; i < endIndex; i++) { %>
                        <% Product product = searchResultsCategory.get(i);%>
                                ...
                                <div class="text-center py-4">
                                 <a class="h6 text-decoration-none text-truncate" href="ProductDetailServlet?productID=<%=product.getProductID()%>"><%= product.getName()%></a>
                                    <div class="d-flex align-items-center justify-content-center mt-2">
                                       <div class="d-flex align-items-center justify-content-center mt-2">
                                                <div style="text-decoration: line-through; color: gray;">₫<%=product.getPrice()%></div>
                                                <h5 style="color: red; margin-left: 10px;">
                                                    ₫<span id="formattedPrice<%=product.getProductID()%>"></span>
                                                </h5>
                                                <script>
                                                    ...
                                                    document.getElementById("formattedPrice<%=product.getProductID()%>").innerText = formattedPrice.toLocaleString();
                                                </script>
                                            </div>
                                         ...
                                         <h5  style="position: absolute;
                                                ...
                                                border-radius: 5px;
                                                font-size: 12px;
                                                color: #333;">₫<%= product.getDiscount()%></h5>
