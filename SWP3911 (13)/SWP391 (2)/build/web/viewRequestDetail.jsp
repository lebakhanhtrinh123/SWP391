<%-- 
    ...
    Created on : Nov 16, 2023, 11:19:38 AM
    Author     : Admin
--%>
        ...
        <main class="app-content" style="margin-left: 250px;">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb">
                    <li class="breadcrumb-item"><a href="ManageRequestController">Danh sách đơn đặt hàng</a></li>
                    <li class="breadcrumb-item"><a href="#">Xem thông tin chi tiết đơn đặt hàng</a></li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        <h3 class="tile-title">Đơn đặt hàng</h3>
                        <div class="tile-body">
                            <form action="UpdateRequest" class="row">
                                ...
                                <div class="form-group  col-md-4">
                                    ...
                                    <input readonly="" class="form-control" type="text" value="${price}" disabled>
...
<!--                                <div class="form-group  col-md-4">
                        ...
                        <a class="btn btn-save" href="ManageRequestController">Quay về</a>           
