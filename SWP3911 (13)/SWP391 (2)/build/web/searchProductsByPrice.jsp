            ...
            <div class="row px-xl-5">
                ...
                <div class="col-lg-12 col-md-8">
                    <div class="row pb-3">
                        ...
                        <%
                            List<Product> searchResultsByPrice = (List<Product>) session.getAttribute("searchResultsByPrice");
                        %>

                        <% if (searchResultsByPrice != null && !searchResultsByPrice.isEmpty()) { %>


                        <% int totalPages = (int) Math.ceil((double) searchResultsByPrice.size() / PAGE_SIZE); %>
                        <% int startIndex = (currentPage - 1) * PAGE_SIZE; %>
                        <% int endIndex = Math.min(startIndex + PAGE_SIZE, searchResultsByPrice.size()); %>



                        <% for (int i = startIndex; i < endIndex; i++) { %>
                        <% Product product = searchResultsByPrice.get(i);%>
                        <!-- Hiển thị sản phẩm -->
