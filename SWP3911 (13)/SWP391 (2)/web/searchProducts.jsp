...
<!--            <div class="row bg-secondary py-1 px-xl-5">
        ...
        <div class="container-fluid">
            <div class="row px-xl-5">
                ...
                <%
                    final int PAGE_SIZE = 40; // Số sản phẩm hiển thị trên mỗi trang
                ...
                <div class="col-lg-12 col-md-8">
                    <div class="row pb-3">
                        ...
                        <% List<Product> searchResultsByName = (List<Product>) session.getAttribute("searchResultsByName"); %>
                        ...
                        <% Product product = searchResultsByName.get(i);%>
                        <!-- Hiển thị sản phẩm -->
                                    ...
                                    <div class="discount-price">
                                        <c:if test="${product.discount > 0}">
                                            <h4 style="position: absolute;
                                                ...
                                                border-radius: 5px;
                                                font-size: 12px;
                                                color: #333;">Giảm: <%=product.getDiscount()%></h4>
                                        </c:if>
                                    </div>
