        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="ManagerStaffController">Thêm nhân viên</a></li>
                </ul>
            </div> 
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        ...
                        <a class="btn btn-cancel" href="ManagerStaffController">Hủy bỏ</a>
                    </div>
                </div>
            </div>
        </main>
...
//                    birthdayError.textContent = "Vui lòng chọn một ngày trước ngày hiện tại.";
