...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6 bg-light p-4">
            <h2 style="color: #FFD333">LỒNG CHIM VN</h2>
            <p class="font-weight-semi-bold mb-2">Số điện thoại: 0394700149</p>
            <p class="font-weight-semi-bold mb-2">Địa chỉ Shop: 806/19 Hà Huy Giáp, Thạnh Lộc, Quận 12, Thành phố Hồ Chí Minh</p>
            <h4 class="font-weight-semi-bold mb-2">Về LỒNG CHIM VN</h4>
            <p>
                Chào mừng quý khách đến với hệ thống bán lồng chim trực tuyến longchimvvn.net. Cơ sở sản xuất và kinh doanh của chúng tôi được thành lập với mong muốn được giới thiệu sản phẩm làng nghề truyền thống đến các nghệ nhân chơi chim cảnh.
            </p>
            <p>
                Chúng tôi cam kết cung cấp cho tất cả các nghệ nhân và khách hàng chơi chim cảnh những món hàng có chất lượng cao với giá cả phù hợp nhất. Quý khách có nhu cầu nâng cấp lồng, phụ kiện lồng để nuôi chim... mà chúng tôi hiện tại chưa có sẵn, đừng ngần ngại hãy gọi cho chúng tôi và cho chúng tôi biết yêu cầu của quý khách.
            </p>
            <p>
                Chúng tôi cũng sẵn sàng hợp tác với các cửa hàng, các nhà cung cấp lồng chim và phụ kiện... trong việc cung cấp, mua bán hoặc trao đổi hàng.
            </p>
            <p>Mọi vấn đề xin vui lòng liên hệ:</p>
            <p>	Phùng Minh Nhật (0946 094 192) Hoặc: Lê	Bá Khánh Trình</p>
            <p>Xin cảm ơn! LỒNG CHIM VN</p>
        </div>
