                    ...
                    <div class="tile">
                        <div class="tile-body">
                            <div class="row element-button">
                                <div class="col-sm-2">
                                    <a class="btn btn-add btn-sm" href="AddPromotion" title="Thêm">
                                        <i class="fas fa-plus"></i> Tạo mới khuyến mãi
                                    </a>
                                </div>
                                ...
                                <div class="col-sm-2" style="display: flex; align-items: center;">
                                    <form style="display: flex; align-items: center;">
                                        ...
                                        <button style="margin-left: 10px;" class="btn btn-primary btn-sm" type="button" onclick="filterByDate()" title="Tìm kiếm">
