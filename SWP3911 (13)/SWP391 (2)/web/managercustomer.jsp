<%-- 
    ...
    Created on : Oct 14, 2023, 10:11:15 AM
    Author     : DELL
--%>
        ...
        <main class="app-content">
            <div class="app-title"> 
                <ul class="app-breadcrumb breadcrumb side">
                    <li class="breadcrumb-item active"><a href="#"><b>Danh sách tài khoản khách hàng </b></a></li>
                </ul>
                <div id="clock"></div>
            </div>
            <div class="row">
                        ...
                        <div class="tile-body">
                            <div class="row element-button">
                                ...
                                <table class="table table-hover table-bordered" id="sampleTable">
                                    ...
                                    <tbody>                                        
                                        <c:forEach items="${requestScope.listcustomer}" var="user">
                                            <tr>
                                                ...
                                                <td style="display: flex; justify-content: space-left">
                                                     ...
                                                     <form action="DeleteCustomer" method="Post" id="deleteForm">
                                                        <button class="btn btn-primary btn-sm trash" type="button" title="Khóa tài khoản người dùng " onclick="confirmDelete(this)"
                                                                data-email="${user.email}">
                                                            <i class="fas fa-trash-alt"></i>
                                                        </button>
                                                    </form>
                                                     <form action="AddCustomer" method="Post">
                                                        <button class="btn btn-primary btn-sm edit" type="button" title="Mở lại tài khoản người dùng" onclick="confirmAdd(this)"
                                                                data-email="${user.email}">
                            ...
                            function confirmDelete(button) {
                                ...
                                swal({
                                    ...
                                    if (willDelete) {
                                        ...
                                        form.action = "DeleteCustomer?email=" + email;
                        ...
                        <script>
                            function confirmAdd(button) {
                                ...
                                swal({
                                    ...
                                    if (willDelete) {
                                        var form = button.closest("form");
                                        form.action = "AddCustomer?email=" + email;
                                        form.submit();
                                    }
                        ...
                        <!--------------------------------------------------------------------------------------------------->
                         ...
                         <script>
                            ...
                            function getData(i) {
                                $.ajax({
                                    type: 'Post',
                                    url: '${pageContext.request.contextPath}/ListUserbyID',
                                    data: {
                                        id: i
                                    },
