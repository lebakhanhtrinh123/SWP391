...
//                }
     ...
     public List<Product> getProductByCategory(String id, String productID) {
        String sql = "  Select p.*,c.categoryName from Product p left join Category c on p.category = c.id where c.id = ? AND p.id != ? and p.code not like 'LCD%'";
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
         List<Product> list = new ArrayList<>();
...
//To change body of generated methods, choose Tools | Templates.
    ...
    public List<Product> searchProductsByCategory(String categoryName) {
      ArrayList<Product> list = new ArrayList<>(); 
       String sql = "Select p.*,c.categoryName from Product p left join Category c on p.category = c.id where c.categoryName = ? and p.code not like 'LCD%'";
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
    try{
...
//To change body of generated methods, choose Tools | Templates.
    ...
    public static void main(String[] args){
        ...
        List<Product> list = pdo.getProductByCategory("1", "1");
    ...
    public List<Product> searchProductsByMaterial(String materialName) {
      ArrayList<Product> list = new ArrayList<>(); 
       String sql = "Select p.*,c.original from Product p left join Material c on p.material = c.id where c.original = ? and p.code not like 'LCD%'";
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
    try{
