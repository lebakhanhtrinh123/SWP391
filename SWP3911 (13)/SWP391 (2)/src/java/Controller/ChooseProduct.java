 ...
 * @author Admin
 */
@WebServlet(name = "ChooseProduct", urlPatterns = {"/choose"})
public class ChooseProduct extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<Product> listProduct = pdo.getProductByCategory(cateid, id1);
        ...
        request.getRequestDispatcher("chooseProduct.jsp").forward(request, response);
        }
    }
